...
<figure style="text-align:center;">
  <img src="../images/DOFA.png" alt="Fine-tuning DOFA" style="width:60%;">
...
<figure style="text-align:center;">
  <img src="../images/GLB.png" alt="GLB coverage" style="width:60%;">
  <figcaption style="font-size:14px;color:gray;">
...
<figure style="text-align:center;">
  <img src="../images/GLB_random.png" alt="Split map" style="width:60%;">
  <figcaption style="font-size:14px;color:gray;">
...
<figure style="text-align:center;">
  <img src="../images/challenge1.png" alt="Challenging cases" style="width:60%;">
  <figcaption style="font-size:14px;color:gray;">
